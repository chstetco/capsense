...
class Panda(Robot):
    ...
    def init(self, directory, id, np_random, fixed_base=True):
        ...
        #self.body = p.loadURDF(os.path.join(directory, 'ur10', 'ur10.urdf'), useFixedBase=fixed_base,
        #                       basePosition=[-1, -1, 0.5], flags=p.URDF_USE_SELF_COLLISION, physicsClientId=id)
